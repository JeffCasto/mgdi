      ...
      >
        ...
        >
          ...
          {message.metadata.model && (
            <span style={{ opacity: 0.7 }}>{message.metadata.model}</span>
          )}
        ...
        <div
          ...
          dangerouslySetInnerHTML={{
            __html: sanitizeHtml(marked(message.content) as string),
          }}
        />
...
export default function MessageList() {
  const { messages, currentStreamingMessage, isStreaming, error } =
    useChatStore();
