...
describe('Timeline Component', () => {
  ...
  test('renders timeline with memories', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByText('Discussed React optimization')).toBeInTheDocument();
    });
...
// TODO: Add integration tests with real API endpoints
// TODO: Test auth-gated memory access
// TODO: Test memory search functionality
